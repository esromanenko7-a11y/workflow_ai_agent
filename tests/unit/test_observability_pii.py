...
def test_redact_pii_masks_inn_and_passport() -> None:
    raw_text = "ИНН 7707083893, паспорт 45 10 123456"
...
def test_redact_pii_keeps_safe_text_readable() -> None:
    raw_text = "Пакет данных заблокирован из-за ошибки в metadata.json"
