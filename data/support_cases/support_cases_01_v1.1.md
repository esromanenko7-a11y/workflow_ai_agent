...
Категория документа: support_cases
Код правила или сценария: КЕЙС_ОТСУТСТВУЕТ_ОБЯЗАТЕЛЬНОЕ_ПОЛЕ
...
Обнаружена проблема по правилу КЕЙС_ОТСУТСТВУЕТ_ОБЯЗАТЕЛЬНОЕ_ПОЛЕ. Проверьте файл пакета,
