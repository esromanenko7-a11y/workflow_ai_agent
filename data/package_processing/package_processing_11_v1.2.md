...
Код правила или сценария: ФОРМИРОВАНИЕ_ИТОГОВОГО_СТАТУСА_ПАКЕТА
...
Обнаружена проблема по правилу ФОРМИРОВАНИЕ_ИТОГОВОГО_СТАТУСА_ПАКЕТА. Проверьте файл пакета,
