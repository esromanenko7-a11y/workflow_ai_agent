...
Категория документа: package_processing
Код правила или сценария: ПРАВИЛА_ПЕРЕХОДА_ПАКЕТА_МЕЖДУ_ЭТАПАМИ
...
Обнаружена проблема по правилу ПРАВИЛА_ПЕРЕХОДА_ПАКЕТА_МЕЖДУ_ЭТАПАМИ. Проверьте файл пакета,
