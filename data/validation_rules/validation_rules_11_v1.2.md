...
Категория документа: validation_rules
Код правила или сценария: ПРОВЕРКА_РЕЗУЛЬТАТА_АВТОМАТИЧЕСКОГО_КОНТРОЛЯ
...
Обнаружена проблема по правилу ПРОВЕРКА_РЕЗУЛЬТАТА_АВТОМАТИЧЕСКОГО_КОНТРОЛЯ. Проверьте файл пакета,
