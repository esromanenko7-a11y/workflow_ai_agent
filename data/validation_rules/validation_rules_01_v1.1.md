...
Код правила или сценария: ПРОВЕРКА_ОБЯЗАТЕЛЬНЫХ_ТЕХНИЧЕСКИХ_ПОЛЕЙ
...
Обнаружена проблема по правилу ПРОВЕРКА_ОБЯЗАТЕЛЬНЫХ_ТЕХНИЧЕСКИХ_ПОЛЕЙ. Проверьте файл пакета,
